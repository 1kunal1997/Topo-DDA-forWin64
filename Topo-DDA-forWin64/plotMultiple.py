    ...
    for step in stepArray:
        for weight in weightArray:
            for penaltytype in penaltytypeArray:
                ...
                pos = "..\\Calculations\\Random Initial Structure\\arandominitialstructuredebug2_it300_lam542_sym_filter2only_periodicFalse_beta0_epsilon_0.1_penaltytype_piecewise_absolute_0.0to0.5\\"
